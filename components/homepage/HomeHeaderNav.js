...
//   footer.map((slice, index) => {
//     return (
//       <div className="column small-order-1 medium-order-2 small-4 medium-3" key={ 'footer-column-' + index }>
//         <span className="title">{ RichText.asText(slice.primary['title-column'])}</span>
//         <ul>
//           { footerLinks(slice.items, index) }
//         </ul>
//       </div>
//     )
//   })
  ...
  return (
    <header className="globalNav initialized noDropdownTransition">
        ...
        <nav>
          <ul className="navRoot">
            <li className="navSection logo">
              <a className="rootLink item-home colorize" href="/fr" aria-label="Stripe homepage">
            ...
            <li className="navSection primary">
              ...
              <button className="rootLink item-developers hasDropdown colorize" data-dropdown="developers"
            ...
            <li className="navSection secondary">
              ...
              <a className="rootLink item-dashboard colorize" data-adroll-segment="submit_two"
                ...
                data-analytics-action="sign_in" data-convert-cta="dashboard_register">
                <span>Sign in</span>
              </a>
            </li>
                        ...
                        <li>
                          <a className="linkContainer item-terminal" href="/fr/terminal" data-analytics-action="terminal"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                              <path className="hover-fillLight" d="M38,8H10L.19,27a24,24,0,0,0,47.62,0Z" fill="#87bbfd">
                              </path>
      ...
      <div className="dropdownRoot">
        <div className="dropdownBackground" style={{transform: 'translateX(412px) scaleX(1.11053) scaleY(1.265)'}}>
          <div className="alternateBackground" style={{transform: 'translateY(252.964px)'}}></div>
        </div>
        <div className="dropdownArrow" style={{transform: 'translateX(623px) rotate(45deg)'}}></div>
        <div className="dropdownContainer" style={{transform: 'translateX(412px)', width: '422px', height: '506px'}}>

          <div className="dropdownSection left" data-dropdown="products" aria-hidden="true">
            <div className="dropdownContent" style={{width: '494px', height: '643px'}}>
                  ...
                  <li>
                    <a className="linkContainer item-payments" href="/fr/payments" data-analytics-action="payments"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">A complete payments platform engineered for&nbsp;growth.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a className="linkContainer item-subscriptions" href="/fr/billing" data-analytics-action="billing"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Build and scale your recurring business&nbsp;model.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a className="linkContainer item-sigma" href="/fr/sigma" data-analytics-action="sigma"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Your business data at your fingertips.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a className="linkContainer item-atlas" href="/atlas" data-analytics-action="atlas"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Turn your idea into a&nbsp;startup.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a className="linkContainer item-radar" href="/fr/radar" data-analytics-action="radar"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Fight fraud with machine learning.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a className="linkContainer item-issuing" href="/fr/issuing" data-analytics-action="issuing"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Create, distribute, and manage&nbsp;cards.</p>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a className="linkContainer item-terminal" href="/fr/terminal" data-analytics-action="terminal"
                      ...
                      <div className="productLinkContent">
                        ...
                        <p className="linkSub">Build your perfect point of&nbsp;sale.</p>
                      </div>
                    </a>
                  </li>
                </ul>
          ...
          <div className="dropdownSection left" data-dropdown="developers" aria-hidden="true">
            <div className="dropdownContent" style={{width: '393px', height: '421px'}}>
              ...
              <div className="linkGroup documentationGroup">
                ...
                <div className="documentationArticles">
                  <ul>
                    ...
                    <li>
                      <a href="/docs/libraries" data-analytics-action="docs_libraries"
                        data-analytics-source="nav_dropdown" tabIndex="-1">
                        Libraries
                      </a>
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="/docs/apple-pay" data-analytics-action="docs_apple_pay"
                        data-analytics-source="nav_dropdown" tabIndex="-1">
                        Apple Pay
                      </a>
                    </li>
          ...
          <div className="dropdownSection active" data-dropdown="company" aria-hidden="true">
            <div className="dropdownContent" style={{width: '422px', height: '506px'}}>
