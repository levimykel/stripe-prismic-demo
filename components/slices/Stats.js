...
const renderStats = (items, colors) => {
  return items.map((item,index) => {
    return (
      <div className="big-stat" key={"big-stat-"+index}>
        <div className="big-stat-data">
          <span className="big-stat-number" style={{ color: colors.primary }}>
...
const Stats = ({ slice, colors }) => {
  return (
    <Fragment>
                ...
                <g transform="translate(-790.000000, -769.000000)" fillRule="nonzero">
                  <g transform="translate(334.000000, 769.000000)">
                    <g transform="translate(456.000000, 0.000000)">
                      <circle id="Oval" fill={ colors.primary53 } cx="36" cy="36" r="36"></circle>
                      <rect id="Rectangle-path" fill={ colors.primary28 } x="17" y="45" width="5.88" height="12" rx="1.5"></rect>
                      <rect id="Rectangle-path" fill={ colors.primary28 } x="25.03" y="44" width="5.88" height="13" rx="1.5"></rect>
                      <rect id="Rectangle-path" fill={ colors.primary28 } x="33.06" y="41" width="5.88" height="16" rx="1.5"></rect>
                      <rect id="Rectangle-path" fill={ colors.primary28 } x="41.09" y="36" width="5.88" height="21" rx="1.5"></rect>
                      <rect id="Rectangle-path" fill={ colors.primary28 } x="49.12" y="31" width="5.88" height="26" rx="1.5"></rect>
                      <path
                        ...
                        id="Shape" fill={ colors.primary }></path>
                      <path
      ...
      <div className="container-lg">
        <div className="stats">
          { renderStats(slice.items, colors) }
        </div>
      </div>
    </Fragment>
  )
