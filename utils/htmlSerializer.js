...
export const customList = (colors) => {
  return (type, element, content, children, key) => {
    let props = {}

    switch (type) {

      case Elements.listItem: // List item with custom bullet
        return (
          <li key={'list-item-'+key}>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
              ...
              <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill={colors.primary_50} stroke="none">
